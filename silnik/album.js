...
(function (globalny) {
  ...
  const KARTY = [
    ...
    { id: 'owad:chrzaszcz', tytul: 'Chrząszcz', rys: 'owad:chrzaszcz',
      fakt: 'Ma twardy pancerz z błyszczących pokryw skrzydeł. Powolny, ale duży i pożywny.' },
    { id: 'owad:pszczola', tytul: 'Pszczoła', rys: 'owad:pszczola',
      fakt: 'Lata od kwiatu do kwiatu po nektar. Modliszka storczykowa wabi ją, udając kwiat.' },
    { id: 'owad:osa', tytul: 'Osa', rys: 'owad:osa',
      fakt: 'Szybka, nerwowa i bardzo czujna. Żeby ją złapać, trzeba podejść naprawdę wolno.' },
    { id: 'owad:motyl', tytul: 'Motyl', rys: 'owad:motyl',
      fakt: 'Leci chwiejnie i siada na kwiatach. Diabeł kwiatowy czeka nieruchomo, aż motyl sam przyleci.' },
    ...
    { id: 'modliszka:olbrzymia', tytul: 'Modliszka olbrzymia', lac: 'Ischnomantis gigas', rys: 'modliszka:olbrzymia',
      fakt: 'Najdłuższa modliszka świata. Samica dorasta do 17 cm. Żyje na suchych sawannach Afryki i mimo długości jest bardzo smukła.' },
    { id: 'modliszka:diabel', tytul: 'Diabeł kwiatowy', lac: 'Idolomantis diabolica', rys: 'modliszka:diabel',
      fakt: 'Jedna z największych modliszek. Gdy się broni, unosi odnóża i pokazuje jaskrawe kolory, żeby wyglądać groźnie i o wiele większa.' },
